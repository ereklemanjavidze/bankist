...
const startLogOutTimer = function () {
  const tick = function () {
    ...
    if (time === 0) {
      clearInterval(timer);
      labelWelcome.textContent = 'login to get';
...
console.log(16156416115166516161651516516516n);
console.log(BigInt(4654116));

//operators
console.log(10000n + 10000n);
console.log(6161616846103161661616164n * 10000n);
//console.log(Math.sqrt(16n));

const huge = 16161684616416161641n;
const num = 23;
...
console.log(new Date('Mon Jan 23 2023 18:40:58'));
...
console.log(
  'Germany:      ',
  new Intl.NumberFormat('da-DE', options).format(num)
);
console.log(
  'Syria:      ',
